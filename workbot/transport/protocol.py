...
def response(req: Message, *, data: dict[str, Any] | None = None) -> Message:
    return Message(type="response", correlation_id=req.id, task_id=req.task_id,
                   source=req.target, target=req.source, data=data or {})


def event(name: str, *, data: dict[str, Any] | None = None, task_id: str | None = None,
          source: str | None = None, target: str | None = None) -> Message:
    return Message(type="event", event=name, task_id=task_id, source=source, target=target, data=data or {})
